...
<head>
    ...
    <script type="text/javascript" src="JS/My%20photo.js"></script>
</head>
<body>
<header>
    <nav>
...
<div class="myPhoto">
    <p class="frontTitle">My Photo</p>
    <?php
    for($i=0;$i<5;$i++) {
        echo '<div class="photoCollection">';
        ...
        echo '<button type="submit" name="modify" class="modify">Modify</button>';
