...
<form action="php/update.php" method="post" enctype="multipart/form-data" name="form">
    <div class="upload">
        <p>Modify your picture</p>
        <div class="picture">
            <img id="upPicture"><br>
            <input type="file" id="picName" name="imgfile" onchange="reupload()"><br>
        </div>
    </div>
    ...
    <button type="submit" name="upload" value="Upload" class="uploadBtn" onclick="return checkupdate()">Modify</button>
</form>
<footer>
